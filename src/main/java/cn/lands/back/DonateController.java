...
import cn.lands.utils.DateUtils;
...
public class DonateController extends AbstarctBackController {
	...
	public static final String EMAIL = "522914767@qq.com";
	...
	/* (non-Javadoc)
	 * @see cn.lands.back.AbstarctBackController#doPage(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.lands.back.AbstarctBackController#edit()
	 */
	@Override
	public void edit() {
